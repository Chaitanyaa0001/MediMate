...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Submitted Doctor Registration:', registerdata);
    // reset optional
    // setregisterdata({
    //   firstname: '',
    //   lastname: '',
          ...
          <div className='flex flex-col gap-5 mb-10'>
            ...
            <div className='bg-white p-2 rounded-[6px] lg:p-10 border-2 border-red-600 flex flex-col'>
              ...
              <div>
                ...
                <input type="text" name="experienceyear" value={registerdata.experienceyear} onChange={handleChange} placeholder="e.g. 2020" required className='w-full p-1.5 border-1 mb-4 border-gray-400 focus:outline-none focus:border-red-500 focus:border-2 rounded-[6px]' />
              </div>
             
              <h2>Additional Certifications</h2>
              <textarea name="certificates" value={registerdata.certificates} onChange={handleChange} placeholder="Certificates, fellowships, or specialized training" className='w-full p-1.5 border-1 mb-4 border-gray-400 focus:outline-none focus:border-red-500 focus:border-2 rounded-[6px]'></textarea>
            </div>
            ...
            <div className='bg-white p-2 rounded-[6px] lg:p-10 border-2 border-red-600 flex flex-col'>
              ...
              <textarea name="biography" value={registerdata.biography} onChange={handleChange} placeholder="Brief biography" className='w-full p-1.5 border-1 border-gray-400  mb-4 focus:outline-none focus:border-red-500 focus:border-2 rounded-[6px]'></textarea>
              <h2 className='italic font-semibold  sm:text-[1rem] '>Charges</h2>
              <input type="number" name="charges" value={registerdata.charges} onChange={handleChange} placeholder="Consultation Charges" required className='w-full p-1.5 border-1 mb-4 border-gray-400 focus:outline-none focus:border-red-500 focus:border-2 rounded-[6px]' />
