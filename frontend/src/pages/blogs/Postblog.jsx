      ...
      <div className="p-6 lg:w-[85%] mx-auto min-h-[90vh]">
        ...
        {showForm && (
          <form
            ...
            className="bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-8 space-y-4 animate-fade-in"
          >
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full border rounded-md px-4 py-2 mt-1 focus:ring-2 ring-red-300"
              />
            </div>
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {blogs.map((blog, index) => (
              ...
              >
                <h3 className="text-lg font-semibold text-red-700">{blog.title}</h3>
